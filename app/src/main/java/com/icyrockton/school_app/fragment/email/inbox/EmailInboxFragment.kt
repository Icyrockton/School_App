...
class EmailInboxFragment : Fragment(), EmailHandler {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.inboxLiveData.observe(viewLifecycleOwner, Observer { data ->
    ...
    override fun goToDetail(message_ID: String,title:String) {
        findNavController().navigate(
            R.id.action_emailFragment_to_emailDetailFragment,
            bundleOf("message_ID" to message_ID,"title" to title)
        )
    }
}